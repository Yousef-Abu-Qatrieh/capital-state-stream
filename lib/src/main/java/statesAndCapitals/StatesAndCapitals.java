...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        StateInfo cardinalState = states.stream()
                .filter(stateInfo -> stateInfo.getStateBird().matches("cardinal"))
        ...
        Map<String, Long> numberOfStatesByTimeZone = states.stream().map(StateInfo::getCapital).collect(Collectors.groupingBy(CapitalInfo::getTimeZone,Collectors.counting()));
        ...
        Map<String, Long> numberOfStateCapitalsByTimeZone = states.stream().map(StateInfo::getCapital).collect(Collectors.groupingBy(CapitalInfo::getTimeZone,Collectors.counting()));
